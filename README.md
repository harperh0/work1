...
- Code files: [Node.js files, API integration scripts]
- Database: [MySQL schema and connection details]
- Documentation: [Web app setup and configuration]
...
1. Navigate to the Data Processing module.
2. Execute the R scripts in the specified order for thorough data cleaning and collation.

### Web App Buildup

1. Access the Web App module.
2. Run Node.js files to start the web application.
3. Ensure MySQL is running and correctly configured.

### Web Page Creation

1. Go to the Web Page module.
2. Open HTML files to view the interactive maps.
3. Modify EJS templates for any desired changes.
...
The code and associated files in the "work1" project are the intellectual property of Hsin Pai. All rights are reserved by the copyright holder. This code is intended for the exclusive viewing of potential employers to assess the coding and analytical skills of Hsin Pai.
